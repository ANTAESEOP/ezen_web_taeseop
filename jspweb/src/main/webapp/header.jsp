...
<body>
	...
	<div class="webbox">
		...
		<div class="hd_top">
			...
			<div>
				<!--  로고 -->
				<span class="hd_title"> <a href="/jspweb/index.jsp"
					class="nav-link">Phone Shop </a>
				</span>
			</div>
			...
			<ul class="hd_sub">
				<!-- 비로그인 메뉴 -->
				<%if(loginid == null){%>
				<li><a href="/jspweb/member/login.jsp" class="nav-link">로그인</a>
				</li>
				<li><a href="/jspweb/member/signup.jsp" class="nav-link">회원가입</a>
				</li>
				<% }else if(loginid.equals("admin")){ %>
				<li><a href="/jspweb/admin/dashboard.jsp" class="nav-link">관리자</a></li>
				<!-- 관리자 페이지 -->
				...
				<li><a href="/jspweb/member/logout.jsp" class="nav-link">
						로그아웃 </a></li>
				<%}		%>

				<!-- 공통 메뉴  -->
				<li><a href="/jspweb/member/info.jsp" class="nav-link">마이쇼핑</a>
				</li>
				<li><a href="/jspweb/board/list.jsp" class="nav-link">고객센터</a>
				</li>
			</ul>
			<!-- 상단 메뉴 end -->
		</div>
