...
public class OrderDto {
	...
	public OrderDto(int ono, String oname, String ophone, String oddress, String oquest, String odate, int mno,
			int odno, int odamount, int odpirce, int odactive, int pstno) {
		super();
		this.ono = ono;
		this.oname = oname;
		this.ophone = ophone;
	...
	public int getOdpirce() {
		return odpirce;
	}

	public void setOdpirce(int odpirce) {
		this.odpirce = odpirce;
	}
	...
	public String toString() {
		return "OrderDto [ono=" + ono + ", oname=" + oname + ", ophone=" + ophone + ", oddress=" + oddress + ", oquest="
				...
				+ ", odpirce=" + odpirce + ", odactive=" + odactive + ", pstno=" + pstno + "]";
	}
}
