package model.dto.dto;
	...
	public class ProductDto {
		...
		// 풀 생성
		public ProductDto(int pno, String pname, String pcomment, int pprice, float pdiscount, byte pactive,
				String pimg, String pdate, int pcno) {
			super();
			this.pno = pno;
			this.pname = pname;
		...
		public String toString() {
			return "PcategoryDto [pno=" + pno + ", pname=" + pname + ", pcomment=" + pcomment + ", pprice=" + pprice
