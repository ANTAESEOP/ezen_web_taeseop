/*
		1. 9개 버튼 생성 [ 게임판 변수에 모든 보튼을 저장한다. ]
				1. 3개마다 줄바꿈 처리 2 5 8 일때
		2. 버튼 클릭하면 모양 변경
				1. 선택한 버튼의 모양 변경 [ o ]
				2. [컴퓨터] 난수 발생 모양 변경 [ x ]
...
function 게임판그리기(){
		...
		승리 = '' // 승리 변수를 공백으로 초기화
		게임상황 = [null,null,null,null,null,null,null,null,null] // 배열에 9개 null 로 초기화
		let 게임판 = '' // 빈 변수 선언
...
function 버튼선택 ( i ){
		...
		document.getElementById( i ).innerHTML = 'o' // 1. 선택한 번호의 버튼 모양
		...
		// 2. 난수 발생 [ Math.floor(실수) : 소수점 버림 / Math.random() : 0 ~ 1 사이 실수 난수 발생]
